...
-- ----------------------------
BEGIN;
INSERT INTO `adinfo` VALUES ('5f933210183511ea9101edafa428dacf', 3, './public/ad/201912622333039623.png', '123', '2019-12-06 22:33:30.400000', '2019-12-30 08:00:00.000000', 'lkw', 0, '2019-11-27 08:00:00.000', 1);
COMMIT;
...
CREATE TABLE `orderinfo` (
  ...
  `express_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '快递单号，可为空，发货后提交',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='商品分类表\n';
