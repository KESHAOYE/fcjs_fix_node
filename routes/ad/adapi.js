...
app.use('/ADDAD', (req, res, next) => {
        ...
        t.then(data => {
                let sql = `insert into adinfo(id,adid,adimg,shopid,startdue,overdue,priority,create_man,create_date) values(${uuid.v1()},${adid},${img},${shopid},${startdue},${overdue},${priority},${createMan},${ct})`
                mysql(sql).then(data => {
                        res.json({
                            code: 200,
                            message: '添加成功'
